...
class AirportForm(forms.Form):
    ...
    origin = forms.ChoiceField(choices = airport_choice_tup,help_text="Origin Airport:")
    dest = forms.ChoiceField(choices = airport_choice_tup,help_text="Destination Airport:")
    # class Meta:
    #     model = Airports
    #     fields = ('airportname',)
...
class AirlineForm(forms.Form):
    ...
    uniquecarrier = forms.ChoiceField(choices = airline_choice_tup,help_text="Airline:")
    # class Meta:
    #     model = Airlinenames
    #     fields = ('airlinename',)
